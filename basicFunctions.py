...
def gettingExcelData(workbookPage = openWorkbook(archiveName='template')):
    ...
    return {'sitesDict': sitesDict, 'origem': origem, 'destino': destino, 'idaVolta': idaVolta, 'dataIda': dataIda, 'dataVolta': dataVolta, 'qtdAdultos': qtdAdultos, 'qtdCriancas': qtdCriancas, 'qtdBebes': qtdBebes, 'classe': classe}
